...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post applicants_url, params: { applicant: { email: @applicant.email, name: @applicant.name, phone: @applicant.phone } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { email: @applicant.email, name: @applicant.name, phone: @applicant.phone } }
